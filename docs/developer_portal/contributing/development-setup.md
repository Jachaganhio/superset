...
- **Read [AGENT.md](https://github.com/apache/superset/blob/master/AGENT.md) first** - Contains comprehensive development guidelines, coding standards, and active refactor requirements
- Follow the TypeScript migration guidelines and avoid deprecated patterns listed in AGENT.md
...
For detailed development context, environment setup, and coding guidelines, see [AGENT.md](https://github.com/apache/superset/blob/master/AGENT.md).
